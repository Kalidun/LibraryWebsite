<div>
    <div id="menu-section" class="mb-5 w-full flex justify-between">
        ...
        <button class="bg-teal-500 text-white px-2 py-1 rounded hover:bg-teal-400 active:bg-teal-600 transition duration-200" data-modal-target="add-book-modal" data-modal-toggle="add-book-modal">
