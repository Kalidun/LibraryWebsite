        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="flex justify-between items-start p-4 rounded-t border-b">
                ...
                <button type="button"
                    ...
                    data-modal-hide="delete-book-modal" id="close-delete-book-modal">X</button>
                <p class="text-xl font-bold">Are you sure you want to delete this book ?</p>
            </div>
            {{-- Content --}}
            <div class="w-full">
            ...
            <div class="flex justify-between w-full">
                <div class="p-2 w-1/3 flex justify-center">
                    <button
                        ...
                        data-modal-hide="delete-book-modal" id="close-delete-book-modal">No</button>
                </div>
                <form class="p-2 w-1/3 flex justify-center" action="{{ route('data.delete.book') }}" enctype="multipart/form-data"
                    id="kt_modal_delete_book_form" method="POST">
                    @csrf
