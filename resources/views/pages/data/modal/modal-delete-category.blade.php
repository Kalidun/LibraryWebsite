            ...
            <div class="flex justify-between w-full">
                <div class="p-2 w-1/3 flex justify-center">
                    <button
                        ...
                        data-modal-hide="delete-category-modal"" id="close-delete-category-modal">No</button>
                </div>
                <form class="p-2 w-1/3 flex justify-center" action="{{ route('data.delete.category') }}" enctype="multipart/form-data"
                    id="kt_modal_delete_category_form" method="POST">
                    @csrf
