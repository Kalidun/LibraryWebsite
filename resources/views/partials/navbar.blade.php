    <nav class="fixed w-full z-50 top-0 bg-teal-300 p-2">
        <div class="container mx-auto flex items-center justify-between">
            <a class="flex items-center space-x-2" href="{{ route('home') }}">
                ...
                @auth
                    <span class="font-semibold text-lg capitalize truncate max-w-[200px]">{{ Auth::user()->username }}'s Library</span>
                @else
            ...
            <div class="flex gap-4 items-center">
                @auth
                    <button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider"
                        class="text-white bg-teal-300 hover:bg-teal-400 focus:ring-4 focus:outline-none focus:ring-teal-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-teal-300 dark:hover:bg-teal-400 dark:focus:ring-teal-500 hover:text-black"
                        type="button">
